...
$("#about-button").click(function () {
    $("#container").append('<div id="draggable5" class="module_holder"><div id="about" class="module_item">we are all providers. we can hold each other up. we are all providers. we can hold each other up. we are all providers. we can hold each other up. we are all providers. we can hold each other up. we are all providers. we can hold each other up. we are all providers. we can hold each other up. we are all providers. we can hold each other up. we are all providers. we can hold each other up. we are all providers. we can hold each other up. we are all providers. we can hold each other up. we are all providers. we will hold each other up. vvholeheartedly@gmail.com</div>');
